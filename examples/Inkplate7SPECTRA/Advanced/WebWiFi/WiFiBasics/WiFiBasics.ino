 ...
 *
 * @file        WiFiBasics.ino
 * @brief       Example showing how to connect to WiFi on the Inkplate 7SPECTRA and print the status on
 *              the serial monitor
 *
...
void setup()
{
    ...
    /* Initialize the Inkplate display and LVGL in FULL render mode.
       - LV_DISP_RENDER_MODE_FULL : full refresh (required for Inkplate 7SPECTRA)
