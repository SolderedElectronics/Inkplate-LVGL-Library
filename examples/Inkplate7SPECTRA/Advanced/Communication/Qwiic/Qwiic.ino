 ...
 *
 * @file        Qwiic.ino
 * @brief       Example demonstrating easyC (I2C) communication between Inkplate 7SPECTRA
 ...
 *              it on the Inkplate 7SPECTRA e-paper screen using LVGL elements.
 *
 ...
 *
 * For setup instructions and more information about Inkplate 7SPECTRA, visit:
 * https://docs.soldered.com/inkplate/7spectra/quick-start-guide/
 *
 * @hardware    Inkplate 7SPECTRA (ESP32-S3-based e-paper display)
...
static void update_readings()
{
    ...
    float hPa = bme280.readPressure() * 10.0f;                 // hPa
