 ...
 * @brief       Example showing how to calibrate the RTC on Inkplate 10.
...
{
    Serial.begin(115200);
    Serial.println("Starting RTC Calibration LVGL example on Inkplate 10...");
    ...
    // Wake button on Inkplate 10 is also GPIO 36
    pinMode(GPIO_NUM_36, INPUT);

    // Set internal capacitor and clock offset for RTC
    // (same as legacy Inkplate10 example, but via LVGL Inkplate rtc API)
    ...
    // Wait for user to press wake button
