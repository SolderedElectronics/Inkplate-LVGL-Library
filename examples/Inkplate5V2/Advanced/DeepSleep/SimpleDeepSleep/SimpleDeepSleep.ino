 ...
 * @brief       Put Inkplate 5V2 into deep sleep, wake every 30 s, and display the wake count.
 *
 *
 ...
 *
 * This example demonstrates deep sleep with periodic wakeups using a timer.
 *
 * @authors     Soldered
 * @date        November 2025
 ***************************************************
