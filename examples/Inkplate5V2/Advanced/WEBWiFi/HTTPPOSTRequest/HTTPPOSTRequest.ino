 ...
 *              and display the response on Inkplate 5V2 using LVGL.
 *
...
// Webhook endpoint (replace with your unique webhook.site URL)
const char *webhook_url = "https://webhook.site/your-unique-endpoint";
...
void setup() {
  ...
  http.begin(webhook_url); // Set the target URL for the POST request

  // Set HTTP headers and body (JSON payload)
  http.addHeader("Content-Type", "application/json");
  String postData = "{\"device\":\"Inkplate6\", \"status\":\"Hello from Inkplate!\"}";
