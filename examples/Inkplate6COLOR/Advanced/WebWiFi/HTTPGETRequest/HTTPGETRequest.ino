 ...
 * @brief       Example showing how to make an HTTP GET request and display the response on Inkplate 6COLOR
 *
...
void setup() {
  ...
  if (httpCode > 0) {
    ...
    lv_obj_set_width(responseLabel, 448);                          // Limit text width to screen
