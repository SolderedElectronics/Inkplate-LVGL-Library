 ...
 *
 * @file        pins.h
 * @brief       Pin definitions for Inkplate 7SPECTRA
 *
 *
...
// Define the default Spectra6 color indexes. These are the EPD controller's hardware
// LUT codes, which skip index 4 - INKPLATE_BLUE/INKPLATE_GREEN must stay 5/6 (not 4/5)
// since the LVGL flush callback writes these macros straight into the framebuffer
// nibble without going through colorPalette[].
