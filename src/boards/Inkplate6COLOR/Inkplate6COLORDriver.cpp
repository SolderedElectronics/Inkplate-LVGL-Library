...
void EPDDriver::setIOExpanderForLowPower()
{
    ...
    // TOUCHPAD PINS
    expander1.pinMode(IO_PIN_B2, OUTPUT);
    expander1.pinMode(IO_PIN_B3, OUTPUT);
    expander1.pinMode(IO_PIN_B4, OUTPUT);

    expander1.digitalWrite(IO_PIN_B2, LOW);
    expander1.digitalWrite(IO_PIN_B3, LOW);
    expander1.digitalWrite(IO_PIN_B4, LOW);
