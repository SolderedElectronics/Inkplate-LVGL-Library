...
#define LV_STDARG_INCLUDE       <stdarg.h>
    ...
    #define LV_MEM_ADR 0
    #define LV_MEM_POOL_ALLOC   my_psram_alloc
...
#define LV_USE_FS_STDIO 1
    ...
    #define LV_FS_STDIO_CACHE_SIZE 32568    /**< >0 to cache this number of bytes in lv_fs_read() */
#endif
...
#define LV_USE_FS_LITTLEFS 0
    ...
    #define LV_FS_LITTLEFS_LETTER 'S'  /**< Set an upper-case driver-identifier letter for this driver (e.g. 'A'). */
